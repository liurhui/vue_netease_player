...
export default {
    ...
    computed:{
        id(){
            if(this.$route.query.id == undefined) return '139483611';
    ...
    methods:{
        //获取评论
        async getComment(){
            let result = await this.$API.reqCommentAlbum(this.id,this.searchParams.pageSize,(this.searchParams.pageNo-1)*(this.searchParams.pageSize));
