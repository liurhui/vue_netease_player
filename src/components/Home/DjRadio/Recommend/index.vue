            ...
            <ul class="playList">
                <li class="item" v-for="program,index in programs" :key="index">
                    ...
                    <div class="cnt">
                        ...
                        <p class="over">
                            <span class="underline">{{program.dj.brand}}</span></p>
                    </div>
                    <!-- 标签 -->
        ...
        <div class="radioMore clearfix" v-for="dj,index in hotDj" :key="index">
            ...
            <ul class="rdilist clearfix">
                <li v-for="item,index in dj.data" :key="index">
                    ...
                    <div class="cnt">
                        <h3 class="fc over">
                            <span class="underline">{{item.name}}</span> </h3>
...
export default {
    ...
    methods:{
        ...
        async getProgramRecommend(){
            let result = await this.$API.reqPorgramRecommend();
        ...
        async getDjRadioHot(){
            for(let i = 0;i < 5;i++)
            {
                let result = await this.$API.reqDjRadioHot(this.hotDjId[i],4,0);  
                let x = {};
                x.id = this.hotDjId[i];
